...
export default function Files({ files, getFileIcon }: FilesProps) {
  return (
    <>
      <div className="space-y-4">
        {files.map((file, i) => (
          <div key={file.id} className="flex items-center justify-between gap-3">
            ...
            {file.downloadable && (
              <Button className="bg-[#efeff0] dark:bg-[#464646]" size="icon" aria-label="Download file">
      ...
      <div className="bg-background flex items-center justify-center gap-2 rounded-lg p-4 text-center text-gray-500 text-sm">
